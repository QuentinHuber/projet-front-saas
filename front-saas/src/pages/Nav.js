    ...
    <>
        ...
        <Sider collapsible>
          <Menu theme="light" defaultSelectedKeys={["1"]} mode="inline">
            <Menu.Item key="1" className="noHover" icon={<PieChartOutlined />}>
              <span className="text-color">Graphique</span>
            </Menu.Item>
            <Menu.Item key="2" className="noHover" icon={<CalendarOutlined />}>
            ...
            <Menu.Item key="4" className="noHover" icon={<BarChartOutlined />}>
